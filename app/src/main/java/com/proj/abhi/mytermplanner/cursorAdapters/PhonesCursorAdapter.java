...
public class PhonesCursorAdapter extends CursorAdapter{
    public PhonesCursorAdapter(Context context, Cursor c, int flags) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String phoneNum = cursor.getString(
                cursor.getColumnIndex(Constants.Professor.PHONE));
        String type = cursor.getString(
                cursor.getColumnIndex(Constants.Professor.PHONE_TYPE));
