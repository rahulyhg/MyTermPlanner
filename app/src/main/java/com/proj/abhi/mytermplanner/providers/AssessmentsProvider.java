...
public class AssessmentsProvider extends ContentProvider{
    ...
    private static final String AUTHORITY = "com.proj.abhi.assessmentsprovider";
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        return database.query(Constants.Tables.TABLE_ASSESSMENT, null,
    ...
    public Uri insert(Uri uri, ContentValues values) {
        long id = database.insert(Constants.Tables.TABLE_ASSESSMENT,
                null, values);
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        return database.update(Constants.Tables.TABLE_ASSESSMENT,
